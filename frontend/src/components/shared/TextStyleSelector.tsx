...
const i18n = {
  zh: {
    ...
    deleteTemplate: '删除模版',
    deleteTemplateConfirm: '将删除该JSON文本模版骨架（全局生效），此操作不可撤销。确定继续？',
    deleteTemplateSuccess: 'JSON文本模版骨架已删除',
  },
  en: {
    ...
    deleteTemplateConfirm: 'This will delete this JSON text template skeleton globally and cannot be undone. Continue?',
    deleteTemplateSuccess: 'JSON text template skeleton deleted',
  },
};
