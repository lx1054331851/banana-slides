  ...
  zh: {
    ...
    settings: {
      ...
      fields: {
        ...
        gptImageResolutionDesc: "当前展示的是 GPT Image 2 的尺寸档位映射；后续可继续扩展为精确 size、quality、background 等独立参数。",
  ...
  en: {
    ...
    settings: {
      ...
      fields: {
        ...
        gptImageResolutionDesc: "This currently shows the GPT Image 2 size tier mapping; it can later expand into explicit size, quality, background, and output controls.",
