  ...
  zh: {
    ...
    settings: {
      ...
      fields: {
        ...
        gptImageResolutionLabel: "图片尺寸档位",
        gptImageResolutionDesc: "按 OpenAI 官方常用 size 展示。常见尺寸包括 1024x1024、1536x1024、1024x1536、2048x2048、2048x1152、3840x2160、2160x3840。实际限制是最长边不超过 3840、宽高都必须是 16 的倍数、长宽比不超过 3:1。",
        gptImageResolution1K: "1K 常用尺寸：1024x1024（1:1 方图）/ 1536x1024（3:2 横版）/ 1024x1536（2:3 竖版）",
        gptImageResolution2K: "2K 常用尺寸：2048x2048（1:1 方图）/ 2048x1152（16:9 横版）/ 1152x2048（9:16 竖版）",
        gptImageResolution4K: "4K 常用尺寸：3840x2160（16:9 横版）/ 2160x3840（9:16 竖版）/ 2880x2880（1:1 方图）",
  ...
  en: {
    ...
    settings: {
      ...
      fields: {
        ...
        gptImageResolutionLabel: "Image Size Tier",
        gptImageResolutionDesc: "Shown using OpenAI's common GPT Image 2 sizes. Common sizes include 1024x1024, 1536x1024, 1024x1536, 2048x2048, 2048x1152, 3840x2160, and 2160x3840. Actual limits: max edge 3840, both edges must be multiples of 16, and aspect ratio must not exceed 3:1.",
        gptImageResolution1K: "1K common sizes: 1024x1024 (1:1 square) / 1536x1024 (3:2 landscape) / 1024x1536 (2:3 portrait)",
        gptImageResolution2K: "2K common sizes: 2048x2048 (1:1 square) / 2048x1152 (16:9 landscape) / 1152x2048 (9:16 portrait)",
        gptImageResolution4K: "4K common sizes: 3840x2160 (16:9 landscape) / 2160x3840 (9:16 portrait) / 2880x2880 (1:1 square)",
