export const previewI18n = {
  zh: {
    ...
    preview: {
      ...
      historyDelete: "删除此版本",
      historyDeleted: "已删除",
      historyDeleteSuccess: "历史图片已删除",
      historyRestoreSuccess: "历史图片已恢复并切换为当前版本",
      historyDeleteFailed: "删除历史图片失败: {{error}}",
      historyRestoreFailed: "恢复历史图片失败: {{error}}",
      historyDeleteConfirmTitle: "确认删除历史图片",
      historyDeleteConfirmCurrent: "删除当前图片后，会自动切换到其它历史版本；如果没有可用版本，当前页将变为无图片状态。确定继续吗？",
      historyDeleteConfirmNormal: "确定删除这个历史图片版本吗？你仍然可以在历史记录里恢复它。",
      ...
      uploadPageAiImageFailed: "页面级 AI 引用图片上传失败（{{count}} 张）",
  ...
  en: {
    ...
    preview: {
      ...
      historyDelete: "Delete this version",
      historyDeleted: "Deleted",
      historyDeleteSuccess: "History image deleted",
      historyRestoreSuccess: "History image restored and set as current",
      historyDeleteFailed: "Failed to delete history image: {{error}}",
      historyRestoreFailed: "Failed to restore history image: {{error}}",
      historyDeleteConfirmTitle: "Delete history image",
      historyDeleteConfirmCurrent: "Deleting the current image will switch to another history version automatically. If none remains, this page will have no image. Continue?",
      historyDeleteConfirmNormal: "Delete this history image version? You can still restore it from history later.",
      ...
      uploadPageAiImageFailed: "Failed to upload {{count}} page AI reference image(s)",
